...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.NomePapel.ADMINISTRADOR, client_1.NomePapel.ATENDENTE, client_1.NomePapel.ATENDENTE, client_1.NomePapel.MEDICO, client_1.NomePapel.DENTISTA, client_1.NomePapel.PSICOLOGO, client_1.NomePapel.TERAPEUTA, client_1.NomePapel.PSIQUIATRA, client_1.NomePapel.ENFERMEIRO, client_1.NomePapel.NUTRICIONISTA, client_1.NomePapel.FISIOTERAPEUTA),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.NomePapel.ADMINISTRADOR, client_1.NomePapel.ATENDENTE, client_1.NomePapel.DENTISTA, client_1.NomePapel.MEDICO, client_1.NomePapel.PSICOLOGO),
